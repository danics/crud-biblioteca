...
namespace crudBiblioteca.Controllers
{
    public class LeitoresController : Controller
    {
        ...
        public LeitoresController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Endereco,Bairro,Cidade,CPF,Telefone")] Leitor leitor)
        {
